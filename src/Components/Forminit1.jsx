      ...
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <form action="#" className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6">
            <label htmlFor="Email" className="block text-sm font-pixeloidmono text-gray-700"> Email </label>
          ...
          <div className="col-span-6 sm:col-span-3">
            <label htmlFor="Password" className="block text-sm font-pixeloidmono text-gray-700"> Password </label>
          ...
          <div className="col-span-6">
            <p className="text-sm text-gray-500 font-pixeloidmono">
             almost there...
