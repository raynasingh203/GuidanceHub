...
const TagSelect = () => {
  ...
  // Available tags data
  const availableTags = [
    { id: '1', label: 'Data Science', description: 'ok' },
    { id: '2', label: '3D Modeling', description: 'ok' },
    { id: '3', label: 'OO Programming', description: 'ok' },
    { id: '4', label: '2D Animation', description: 'ok' },
    { id: '5', label: 'UI/UX Design', description: 'ok' },
    { id: '6', label: 'Game Design', description: 'ok' },
  ];
