...
const Archivecard1 = () => {
  return (
    <div className='absolute mt-[-122rem] w-[380px] ml-[46rem]'>

<h2 className="mt-[-2.5rem] text-xl font-medium text-black absolute font-pixeloidmono sm:text-3xl">Proj Title</h2>
<div className='w-10 h-10 bg-black absolute font-pixeloidmono text-white mt-[-5.5rem]'> 2  </div>
      ...
      <a href="#" className="group relative block h-[20rem] sm:h-80 lg:h-96">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url(/Images/archiveimg1.png)', // Replace with your image path
          }}
        >
          <div
